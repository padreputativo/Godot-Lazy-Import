...
var hdrs=[
	{ path="res://addons/Lazy_Import/test/art/environment/schelde.hdr", name="Riverside"},
	{ path="res://addons/Lazy_Import/test/art/environment/lobby.hdr", name="Lobby"},
	{ path="res://addons/Lazy_Import/test/art/environment/park.hdr", name="Park"},
	{ path="res://addons/Lazy_Import/test/art/environment/night.hdr", name="Night"},
	{ path="res://addons/Lazy_Import/test/art/environment/experiment.hdr", name="Experiment"},
]
